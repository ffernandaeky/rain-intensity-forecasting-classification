# 🌧️ Rainfall Intensity Forecasting & Classification

Proyek ini menggabungkan analisis data, forecasting, dan machine learning untuk memahami serta memprediksi intensitas curah hujan berdasarkan data historis. Fokus utamanya adalah mengidentifikasi pola hujan dan mengklasifikasikan kondisi hujan ke dalam kategori yang lebih informatif.
...
- Notebook analisis dan pemodelan: berisi eksplorasi data, pelatihan model, dan evaluasi
- Data input: digunakan sebagai sumber utama untuk prediksi dan klasifikasi
- Hasil output: menyimpan hasil forecasting serta evaluasi performa model
